    ...
    async def load_servers_from_config(
        ...
        for server_name, server_config in mcp_servers_config.items():
            ...
            new_server = MCPServer(
                ...
                # ID-JAG fields
                id_jag_resource_token_endpoint=server_config.get(
                    "id_jag_resource_token_endpoint", None
                ),
                ...
                client_assertion_signing_alg=server_config.get(
        ...
        *,
        ...
        new_server = MCPServer(
            ...
            id_jag_resource_token_endpoint=(
                credentials_dict.get("id_jag_resource_token_endpoint")
                if credentials_dict
                else None
            ),
            id_jag_resource=(
            ...
            client_assertion_signing_alg=(
                credentials_dict.get("client_assertion_signing_alg")
                if credentials_dict
                else None
            )
            or "RS256",
